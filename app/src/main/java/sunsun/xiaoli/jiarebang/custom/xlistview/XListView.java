package sunsun.xiaoli.jiarebang.custom.xlistview;
...
public class XListView extends ListView implements OnScrollListener {
	...
	/**抬头查看内容，用它来计算头的高度。把它隐藏当禁用拉loadmsgsfromdb*/
	 ...
	 * @param context
	 */
	public void iniFooerMore(Context context) {
		mFooterView.iniViewmoer(context);
	}
	 ...
	 * @param context
	 */
	public void iniFooder(Context context) {
		mFooterView.iniViewFood(context);
	}
