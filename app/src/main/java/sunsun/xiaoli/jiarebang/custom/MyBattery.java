...
public class MyBattery extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        int baseColor = a.getColor(R.styleable.MyBattery_mb_baseColor, Color.RED);
    ...
    /**
     * @param batteryStatus  电池状状态
     * @param batteryElectricity 电池电量
     */
    public void setBatteryStatus(BatteryStatus batteryStatus,int batteryElectricity){
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (batteryStatus== BatteryStatus.BatteryPowerSupply) {
...
//        canvas.restore();
    ...
    private void drawHead(Canvas canvas) {
        float[] outerR = new float[]{0, 0, 60, 60, 60, 60, 0, 0};
        ...
        mDrawables.setBounds((int)headF.left, (int)headF.top, (int)headF.right, (int)headF.bottom);
    ...
    private void drawBattery(Canvas canvas) {
        ...
        for (int i = 0; i < batteryElectricity; i++) {
