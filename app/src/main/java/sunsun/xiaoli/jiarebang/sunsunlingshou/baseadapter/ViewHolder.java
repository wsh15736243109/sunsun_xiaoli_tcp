...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder setViewBackgroundDrawable(int viewId, Drawable resId) {
        getView(viewId).setBackgroundDrawable(resId);
        return this;
    }
    ...
    public ViewHolder setTag(int viewId, int key, Object value) {
        View view = getView(viewId);
        if (key != -1) {
