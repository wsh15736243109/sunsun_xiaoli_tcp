...
public interface ILingShouInterface<PersonDataBean> {
     ...
     * @param s_id
     */
    void addAddress(String uid, String province, String provinceId, String city, String area, String cityid, String areaid, String detailAddress, String name, String phone, String country_id, String country, String lng, String lat, String s_id);
