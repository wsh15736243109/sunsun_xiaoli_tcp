 ...
 * 公用的Dialog   拨打电话首用
 */
public class UIAlertViewTwo extends Dialog {
    ...
    public UIAlertViewTwo(Context context, String title, String message,
    ...
    public void inite() {
        ...
        View view = inflater.inflate(R.layout.ui_alert_view_two, null);
        setContentView(view);
