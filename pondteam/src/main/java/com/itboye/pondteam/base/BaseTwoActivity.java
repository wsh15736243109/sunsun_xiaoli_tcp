...
@SuppressLint("ResourceAsColor") @TargetApi(Build.VERSION_CODES.HONEYCOMB) public abstract class BaseTwoActivity extends FragmentActivity implements
		OnClickListener {
...
//		PreferenceUtil.commitString("language", language);
	...
	public static final String EVENT_TYPE_UNKNOWN = BaseTwoActivity.class
			.getName() + "_unknown";
