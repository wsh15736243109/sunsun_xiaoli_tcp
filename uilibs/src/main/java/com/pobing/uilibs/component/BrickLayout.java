...
/**
 *
 * Displays child views in horizontal, but when the child cannot be displayed fully on width,
 * it will be arranged in another line.
 *
 * <p>
 * To allow users to copy some or all of the BrickLayout's value and paste it somewhere else, set the
 * XML attribute {@link R.styleable#BrickLayout
 * <b>XML attributes</b>
 * <p>
 * See {@link R.styleable#BrickLayout BrickLayout Attributes},
 *
