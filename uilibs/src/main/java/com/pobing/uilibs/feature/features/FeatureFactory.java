...
public class FeatureFactory {
	...
	static {
		featureMap.put("ClickDrawableMaskFeature", new AttachInfo(
				com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_clickDrawableMaskFeature,
				PRIORITY_ABOVE_NORMAL));
		featureMap
				.put("RatioFeature", new AttachInfo(
						com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_ratioFeature,
						PRIORITY_NORMAL));
		featureMap.put("RoundRectFeature", new AttachInfo(
				com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_roundRectFeature,
				PRIORITY_NORMAL));
		featureMap
				.put("RoundFeature", new AttachInfo(
						com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_roundFeature,
						PRIORITY_NORMAL));
		featureMap.put("ClickViewMaskFeature", new AttachInfo(
				com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_clickViewMaskFeature,
				PRIORITY_BELOW_NORMAL));
		featureMap.put("BinaryPageFeature", new AttachInfo(
				com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_binaryPageFeature,
				PRIORITY_NORMAL));
		featureMap.put("PinnedHeaderFeature", new AttachInfo(
				com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_pinnedHeaderFeature,
				PRIORITY_NORMAL));
		featureMap.put("PullToRefreshFeature", new AttachInfo(
				com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_pullToRefreshFeature,
				PRIORITY_NORMAL));
		featureMap.put("StickyScrollFeature", new AttachInfo(
				com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_stickyScrollFeature,
				PRIORITY_NORMAL));
        featureMap.put("ParallaxScrollFeature", new AttachInfo(
                com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_parallaxScrollFeature,
                PRIORITY_NORMAL));
        featureMap.put("BounceScrollFeature", new AttachInfo(
                com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_bounceScrollFeature,
                PRIORITY_NORMAL));
        
        featureMap.put("PencilShapeFeature", new AttachInfo(
                com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_pencilShapeFeature,
                PRIORITY_NORMAL));
        featureMap.put("AutoScaleFeature", new AttachInfo(
                com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_autoScaleFeature,
                PRIORITY_NORMAL));
        featureMap.put("RotateFeature", new AttachInfo(
        		com.pobing.uilibs.R.styleable.FeatureNameSpace_uik_rotateFeature, PRIORITY_NORMAL));
	}
