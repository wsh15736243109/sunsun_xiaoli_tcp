	...
	public void constructor(Context context, AttributeSet attrs, int defStyle) {
		...
		if (null != attrs) {
			TypedArray a = context.obtainStyledAttributes(attrs,
					com.pobing.uilibs.R.styleable.PencilShapeFeature);
			if (null != a) {
				mRadiusX = a.getDimension(
						com.pobing.uilibs.R.styleable.PencilShapeFeature_uik_radiusX,
						sDefaultRadius);
				mRadiusY = a.getDimension(
						com.pobing.uilibs.R.styleable.PencilShapeFeature_uik_radiusY,
						sDefaultRadius);
				
				mTopRatio = a.getFloat(
						com.pobing.uilibs.R.styleable.PencilShapeFeature_uik_topRatio,
						sTopRatio);
				a.recycle();
			}
		}
