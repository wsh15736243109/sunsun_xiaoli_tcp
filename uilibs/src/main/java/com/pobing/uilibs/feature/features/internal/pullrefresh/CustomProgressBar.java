...
//		mColor = a.getColor(R.styleable.CustomProgressBar_progressColor, 0xFF5000);
//		mRadius = a.getFloat(R.styleable.CustomProgressBar_progressRadio, 12f);
//		mPaint = new Paint();
...
//				Log.i(TAG, "distance : changeProgressBarState : " + distance);
	...
	public void setPullDownDistance(int distance) {
		mDistance = distance ;//+ (int) (distance * 0.4)
//		Log.i(TAG, "distance : setPullDownDistance : " + distance);
	}
